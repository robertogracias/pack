    ...
    def _action_launch_stock_rule(self):
        ...
        for line in self:
            ...
            if not line.order_id.procurement_group_id:
                ...
                for line_id in self:
                    if line_id.product_id.pack_ids:
                        values = line_id._prepare_procurement_values(group_id=line_id.order_id.procurement_group_id)
                        product_qty = line_id.product_uom_qty - qty
                        for val in values:
                            try:
